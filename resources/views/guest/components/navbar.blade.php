            ...
            >
                ...
                <li>
                    <button
                        id="dark-mode-toggle"
                        type="button"
                        class="text-white hover:bg-gray-700 focus:ring-4 focus:outline-none
                        focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-gray-100 shadow-sm"
                    ...
                    >
                        ...
                        >
                            <path
                                ...
                                d="M12 3v1.008c-2.843.147-5.154 2.005-6.848 5.473L9.853 19l4.87-4.87c1.649-1.963 4.013-4.646 6.848-5.473V3zM17.657 16.344C14.084 18.122 10.14 19.172 6.853 19l4.87-4.87c1.649-1.963 4.013-4.646 6.848-5.473V12.18 c-1.768 .345-3.636 1.597-5.707 4.077z"
                            />
                        </svg>
